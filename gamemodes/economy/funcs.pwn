...
{
  new
    ORM:orm = ServerEconomy[ORM] = orm_create(SERVER_ECONOMY_TABLE_NAME, sqlcon)
  ;
...
Economy_InitLoad()
{
  ...
  mysql_tquery(sqlcon, query, "OnEconomyInitLoaded", "d", 0);
  return 1;
}
...
Economy_SetSalesTaxRate(rate)
{
  ...
  ServerEconomy[SALES_TAX_RATE] = rate;
  Economy_Save();
  return 1;
}
...
Economy_UpdateSummary()
{
  ...
  ", FormatMoney(Economy_GetSupply())
  , FormatMoney(Economy_GetReserve())
  , Economy_GetInflationRate()
  , Economy_GetSalesTaxRate()
  , FormatMoney(Economy_GetMaxFactSalaryWeekly())
  , FormatMoney(Economy_GetTreatmentPrice())
  , FormatMoney(Economy_GetComponentPrice())
  , FormatMoney(Economy_GetMaterialPrice())
  , FormatMoney(Economy_GetRentVehOvertimeFine())
  , FormatMoney(Economy_GetRentVehDestroyedFine())
