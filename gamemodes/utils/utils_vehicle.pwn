...
new const g_VehicleModSections[MAX_VEHICLE_MOD_SECTIONS][32] =
{
  {"Bullbar"},
  {"Exhaust"},
  {"Front Bullbars"},
...
new const g_VehicleMods[MAX_VEHICLE_MODS][E_VEHICLE_MOD] =
{
...
new const g_VehicleValidMods[MAX_VEHICLE_MODELS][MAX_VEHICLE_COMPAT_MODS] =
{
